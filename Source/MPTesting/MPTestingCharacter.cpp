...
AMPTestingCharacter::AMPTestingCharacter():
	...
	JoinSessionCompleteDelegate(FOnJoinSessionCompleteDelegate::CreateUObject(this, &AMPTestingCharacter::OnJoinSessionComplete))
{
...
void AMPTestingCharacter::NotifyControllerChanged()
{
...
void AMPTestingCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		...
		{
			World->ServerTravel("/Game/MPTesting/Maps/Lobby?listen");
		}
	}
	else
	{
